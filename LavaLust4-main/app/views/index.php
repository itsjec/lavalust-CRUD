								...
								<div class="modal-header">						
										...
										<div class="modal-body">					
											...
											<div class="form-group">
												...
												<input type="text" value="<?= $user['password']; ?>" name = "password" class="form-control" required>
											</div>
											<div class="form-group">
												<label>Confirm Password</label>
												<input type="text" value="<?= $user['password']; ?>" name = "confirmpassword" class="form-control" required>
											</div>					
										</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<form>
									...
									<div class="modal-footer">
										<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
										<a href="<?= site_URL('delete/'. $user['id']); ?>" type="submit" class="btn btn-danger">Delete</a>
									</div>
								</form>
							</div>
						</div>
